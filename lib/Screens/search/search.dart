...
//         body: Consumer<TransactionProvider>(builder: (context, newList, child) {
//           return Column(
//             children: [
//               Padding(
...
//                     onChanged: (purpose) {
//                       context.read<TransactionProvider>().search(purpose);
...
//                     log(newList.transactionListNotifietr.toString());
//                     final _value = newList.transactionListNotifietr[index];
...
//                     );
//                   },
//                   itemCount: newList.transactionListNotifietr.length,
//                 ),
//               ),
//             ],
//           );
